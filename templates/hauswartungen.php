<?php
    //Template Name: Hauswartungen Template
    get_header();
?>
<div class="container-fluid">
    <div class="row">
        <div class="ld_dienstleistungen-sub">
            ...
            <div class="img-bg">
                <img src="<?php the_field('background_image_h');?>" alt="">
            </div>
                ...
                <div class="row centeredrow">
                    ...
                    <?php 
                        ...
                        ?>
                            ...
                            <div class="intro-post animate__animated animate__tada col-lg-12 col-md-12 float-left">
                ...
                <div class="row">
                    ...
                    <?php 
                        $args = array(
                            ...
                            'order'    => 'ASC',
                            'posts_per_page' => 5,
                            'category_name' => 'after_hauswartungen'
                            );              
